(function () {
  ...
  // ★ タイトルだけ変数化（元の文字列をそのまま移動）
  let chartTitleText = '部門別 売上グラフ';
...
titleLabel.textContent = 'タイトル入力欄';
...
wrapper.appendChild(titleLabel);
    ...
    titleInput.value = chartTitleText;
    ...
    titleInput.addEventListener('input', function () {
      chartTitleText = titleInput.value;
      chartInstance.options.plugins.title.text = chartTitleText;
